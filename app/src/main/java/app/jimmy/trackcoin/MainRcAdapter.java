...
public class MainRcAdapter extends RecyclerView.Adapter<MainRcAdapter.ViewHolder> {
    ...
    public MainRcAdapter(ArrayList<MainDataSet> mainDataSet, Context mConext) {
        dataSet = mainDataSet;
...
// - get element from your dataset at this position
        ...
        Glide.with(mConext).load("https://bitcoin.org/img/icons/opengraph.png").into(holder.coinIcon);
    }
